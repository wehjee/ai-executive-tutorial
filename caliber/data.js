...
window.DB = (function () {
  ...
  const marketplace = [
    { id: 'pa-autopilot', name: 'Prior Auth Autopilot', cat: 'Prior Auth', color: '#0F6E6E',
    ...
    { id: 'denial-drafter', name: 'Denial Appeal Drafter', cat: 'Revenue Cycle', color: '#7C3AED',
    ...
    { id: 'caregap-agent', name: 'Care-Gap Outreach Agent', cat: 'Care Gaps', color: '#0EA5E9',
    ...
    { id: 'ambient-coding', name: 'Ambient Coding Assistant', cat: 'Coding', color: '#16A34A',
    ...
    { id: 'eligibility-bot', name: 'Eligibility Verification Bot', cat: 'Revenue Cycle', color: '#0F6E6E',
    ...
    { id: 'member-triage', name: 'Member Services Triage', cat: 'Member Services', color: '#F59E0B',
